...
func listEvents() -> [Event] {
    ...
    events.append(EventModal(title: "Desenho de Imprensa", textDescription: "Ser desenhista e trabalhar com desenho passa por muitas possibilidades e uma delas é ser desenhista de imprensa. Sobre isso, de como é o trabalho do desenhista de veículo de imprensa, visto através da experiência pessoal do ilustrador, é que se trata esta conversa. Como foi o início, como é a rotina e quais são os desafios do trabalho na redação de um grande jornal, como é trabalhar o desenho na imprensa, o futuro incerto da profissão. Cartunistas, ilustradores, publicitários, artistas, jornalistas, esses são algumas das profissões para quem realiza este ofício.", videoDescription: "", date: "17/8", hour: "8:30", speakerName: "Eduardo Baptistão", speakerPhoto: Image("Eduardo Baptistão")))
    
    events.append(EventModal(title: "Clubhouse: A Revolução Criativa é Colaborativa ", textDescription: "", videoDescription: "", date: "17/8", hour: "9:15", speakerName: "Lucas Foster", speakerPhoto: Image("Lucas Foster")))
