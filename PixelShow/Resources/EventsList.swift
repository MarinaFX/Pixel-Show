...
func listEventsDay1() -> [Event] {
    ...
    events.append(Event(title: "Oficina de Encadernação", textDescription: "", videoDescription: "", date: "17/8", hour: "12:15", speakerName: "Cláudio Brasil", speakerPhoto: Image("Claudio Brasil")))
...
func listEventsDay2() -> [Event] {
    ...
    events.append(Event(title: "Clubhouse: A Revolução Criativa é Colaborativa ", textDescription: "", videoDescription: "", date: "18/8", hour: "9:15", speakerName: "Lucas Foster", speakerPhoto: Image("Lucas Foster")))
    events.append(Event(title: "Insights para Estruturação e Gestão de Iniciativas Culturais e Criativas ", textDescription: "", videoDescription: "", date: "17/8", hour: "10:00", speakerName: "Fernanda Nave", speakerPhoto: Image("Fernanda Nave")))
    events.append(Event(title: "Conectando Migrantes à Economia Criativa", textDescription: "", videoDescription: "", date: "18/8", hour: "11:30", speakerName: "Maria Nilda", speakerPhoto: Image("Maria Nilda")))
    events.append(Event(title: "Oficina de Encadernação", textDescription: "", videoDescription: "", date: "18/8", hour: "12:15", speakerName: "Cláudio Brasil", speakerPhoto: Image("Claudio Brasil")))
    events.append(Event(title: "Desafios da Programação Cultural", textDescription: "", videoDescription: "", date: "18/8", hour: "13:00", speakerName: "Hugo Possolo", speakerPhoto: Image("Hugo Possolo")))
